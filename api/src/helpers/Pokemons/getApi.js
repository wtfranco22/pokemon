...
module.exports = async () => {
    ...
    const pokemons = responses.map((response) => {
        ...
        return { id, name, image: img, hp: stats[0].base_stat, attack: stats[1].base_stat, defense: stats[2].base_stat, speed: stats[5].base_stats, weight, height, types: allTypes };
    });
    if (pokemons[0].name) {
        return pokemons;
    }
